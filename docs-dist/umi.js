(function(e) {
                  ...
                  r['default'].createElement(
                    ...
                    r['default'].createElement(a['default'], {
                      ...
                      onMobileMenuClick: function() {
                        return o.setState({ menuCollapsed: !x });
                      },
                    }),
          ...
          [
            {
              ...
              value: function(e) {
                for (
                  ...
                  var g = (o[h] || { name: '' }).name;
                  if (a.pathname.startsWith('/'.concat(g))) {
                    f.currentLocale = g;
                    break;
                  }
                }
                  ...
                  for (var b = o, w = i; b < n.length; w += n[b].length, ++b) {
                    ...
                    if (!(E instanceof l)) {
                      ...
                      if (x) {
                        ...
                        var C = new l(c, d ? t.tokenize(x, d) : x, m, x, g);
                        if (
                          (P.push(C),
                          I && P.push(I),
        ...
        while (a > -1) {
          while ((i = r[a]++) < o[a]) {
            ...
            if (
              ...
              var v = c.split(p),
                m = v.length;
              u.push({ types: s, content: v[0] });
              for (var y = 1; y < m; y++)
                d(u), l.push((u = [])), u.push({ types: s, content: v[y] });
        ...
        e.apply(this, n),
          ...
          s(this, 'getLineProps', function(e) {
            var n = e.key,
              r = e.className,
              o = e.style,
              i = m(e, ['key', 'className', 'style', 'line']),
              a = i,
              u = f({}, a, {
          ...
          s(this, 'getTokenProps', function(e) {
            var n = e.key,
              ...
              o = e.style,
              i = e.token,
              a = m(e, ['key', 'className', 'style', 'token']),
              u = a,
              l = f({}, u, {
  ...
  '55Ip': function(e, t, n) {
    ...
    var E = b(function(e, t) {
      ...
      return a.a.createElement(r['h'].Consumer, null, function(e) {
        ...
        return (
          y !== b ? (j.ref = t || T) : (j.innerRef = T), a.a.createElement(m, j)
        );
      });
    });
  },
                  ...
                  : r['default'].createElement(
                      ...
                      r['default'].createElement(
                        'div',
                        {
                          ...
                          style: {
                            transform: m ? 'translate(0, 0)' : void 0,
                            padding: b ? '0' : void 0,
                            background: y,
                          },
                        },
  ...
  '5s+n': function(e, t, n) {
    ...
    var r,
      ...
      ae = function(e, t) {
        S.call(c, function() {
          ...
          if (
            o &&
            ((n = R(function() {
              G ? z.emit('unhandledRejection', r, e) : ie(K, e, r);
            })),
            (t.rejection = G || ue(t) ? ee : J),
            n.error)
          )
            throw n.value;
        });
      ...
      le = function(e, t) {
        S.call(c, function() {
          G ? z.emit('rejectionHandled', e) : ie(Y, e, t.value);
        });
      },
      ce = function(e, t, n, r) {
        return function(o) {
  ...
  '8YOa': function(e, t, n) {
    var r = n('0BK2'),
      ...
      g = function(e) {
        return l && v.REQUIRED && f(e) && !i(e, c) && p(e), e;
      },
      v = (e.exports = {
        REQUIRED: !1,
        fastKey: d,
          ...
          [
            ...
            function(e, o) {
              ...
              while (x < p.length) {
                ...
                if (
                  null === O ||
                  (S = h(c(b.lastIndex + (v ? 0 : x)), p.length)) === E
                )
                  x = l(p, x, m);
                else {
      ...
      return o.a.createElement(
        ...
        o.a.createElement(
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              'a',
              { 'aria-hidden': 'true', href: '#hello-statelink' },
  ...
  'I+eb': function(e, t, n) {
    ...
    e.exports = function(e, t) {
      var n,
        ...
        v = e.global,
        m = e.stat;
      if (((s = v ? r : m ? r[g] || u(g, {}) : (r[g] || {}).prototype), s))
        for (f in t) {
          if (
            ((d = t[f]),
            e.noTargetGet ? ((h = o(s, f)), (p = h && h.value)) : (p = s[f]),
            (n = c(v ? f : g + (m ? '.' : '#') + f, e.forced)),
            !n && void 0 !== p)
          ) {
    ...
    var r = n('glrk'),
      ...
      s = (e.exports = function(e, t, n, s, f) {
        ...
        while (!(y = m.call(p)).done)
          if (
            ((v = l(p, b, y.value, s)),
            'object' == typeof v && v && v instanceof c)
          )
            return v;
        return new c(!1);
      });
  ...
  Kz25: function(e, t, n) {
    ...
    v(_e, 'URL'), o({ global: !0, forced: !a, sham: !i }, { URL: _e });
  },
  LKBx: function(e, t, n) {
    'use strict';
    var r = n('I+eb'),
      ...
      return i.a.createElement(
        ...
        i.a.createElement(
          ...
          r(
            ...
            { dependencies: { statelink: '1.0.0' }, files: {} },
          ),
  ...
  R2QN: function(e, t, n) {
    ...
    var f = function(e, t) {
      ...
      var s = t,
        ...
        y = u(u({}, i), p);
      (m =
        m || 'create-react-app-typescript' !== g ? 'index.jsx' : 'index.tsx'),
        c(y);
      var b = u(
          u({}, n),
          {},
          {
            'package.json': { content: (0, o.newpkgJSON)(y, d, m, a || {}, l) },
  ...
  VWci: function(e, t, n) {
    var r = (function(e) {
      ...
      var E = (m.prototype = g.prototype = Object.create(y));
      function x(e) {
  ...
  X7LM: function(e, t, n) {
    ...
    var r = 2147483647,
      ...
      w = function(e, t, n) {
        var r = 0;
        for (e = n ? v(e / l) : e >> 1, e += v(e / t); e > (g * a) >> 1; r += o)
          e = v(e / g);
        return v(r + ((g + 1) * e) / (e + u));
      },
      E = function(e) {
        var t = [];
        e = y(e);
        ...
        while (x < l) {
          ...
          var S = x + 1;
          if (k - p > v((r - d) / S)) throw RangeError(h);
          for (d += (k - p) * S, p = k, n = 0; n < e.length; n++) {
            ...
            if (u == p) {
              for (var O = d, T = o; ; T += o) {
                ...
                var _ = O - A,
                  R = o - A;
                t.push(m(b(A + (_ % R)))), (O = v(_ / R));
              }
              t.push(m(b(O))), (g = w(d, S, x == E)), (d = 0), ++x;
            }
          }
          ++d, ++p;
        }
        ...
        ? function(e, t) {
            ...
            while (o > s) {
              var d,
                ...
                v = g.length,
                m = 0;
              while (v > m) (d = g[m++]), (r && !p.call(h, d)) || (n[d] = h[d]);
            }
            return n;
          }
        : s;
  ...
  YS25: function(e, t, n) {
    ...
    function B(e) {
      ...
      function v(e) {
        Object(r['a'])(X, e),
          (X.length = t.length),
          g.notifyListeners(X.location, X.action);
      }
      var b = !1,
        x = null;
      function T(e, t) {
          ...
          if (e) {
            ...
            if (i) {
              ...
              var a = B.lastIndexOf(w(X.location)),
                u = B.slice(0, a + 1);
              u.push(t), (B = u), v({ action: n, location: r });
            } else v();
          }
        });
      }
      function H(e, t) {
        ...
        g.confirmTransitionTo(r, n, i, function(e) {
          if (e) {
            ...
            -1 !== a && (B[a] = t), v({ action: n, location: r });
          }
        });
      }
      function W(e) {
  ...
  Yhre: function(e, t, n) {
    ...
    if (i) {
      if (
        ...
        for (var V, G = (R[O] = _[O]), $ = v(_), K = 0; $.length > K; )
          (V = $[K++]) in R || a(R, V, _[V]);
        G.constructor = R;
      }
      g && h(P) !== C && g(P, C);
  ...
  bWFh: function(e, t, n) {
    ...
    e.exports = function(e, t, n) {
      ...
      if (
        ...
        (w = n.getConstructor(t, e, g, m)), (u.REQUIRED = !0);
      else if (i(e, !0)) {
        var k = new w(),
          S = k[m](v ? {} : -0, 1) != k,
          O = f(function() {
  ...
  dOgj: function(e, t, n) {
    ...
    var r = n('I+eb'),
      ...
      Y = function(e, t) {
        return K(e, (t = g(t, !0))) ? s(2, e[t]) : C(e, t);
      },
      Z = function(e, t, n) {
        return !(K(e, (t = g(t, !0))) && y(n) && v(n, 'value')) ||
          v(n, 'get') ||
          v(n, 'set') ||
          n.configurable ||
          ...
          M
            ...
            : ((v = t(function(e, t, n, r) {
                ...
                var o,
                  ...
                  f = 0;
                if (y(t)) {
                  if (!$(t)) return z(t) ? V(v, t) : x.call(v, t);
                  (o = t), (f = h(n, i));
                  var g = t.byteLength;
                  if (void 0 === r) {
                    if (g % i) throw N(W);
            ...
            F && f(m, F, u),
            (O[u] = v),
            r({ global: !0, forced: v != g, sham: !M }, O),
            H in v || f(v, H, i),
            H in m || f(m, H, i),
            S(u);
        }))
    ...
    (u[g] = !0),
      (e.exports =
        ...
        function(e, t) {
          ...
          return (
            null !== e
              ? ((v[d] = o(e)), (n = new v()), (v[d] = null), (n[g] = e))
              : (n = w()),
            void 0 === t ? n : i(n, t)
          );
        });
      ...
      if (
        (C &&
          ...
          h !== Object.prototype &&
            ...
            (f ||
              i(k) === h ||
              (a ? a(k, h) : 'function' != typeof k[v] && l(k, v, w)),
            u(k, A, !0, !0),
            f && (p[A] = w))),
        d == y &&
          I &&
        ...
        if (((S = { values: T(y), keys: E ? P : T(m), entries: T(b) }), x))
        ...
        concat: function(e) {
          ...
          for (t = -1, r = arguments.length; t < r; t++)
            if (((i = -1 === t ? a : arguments[t]), b(i))) {
              if (((o = l(i.length)), p + o > g)) throw TypeError(v);
    ...
    r(
      { target: 'String', proto: !0 },
      {
        replaceAll: function e(t, n) {
          ...
          for (g = h[0], v = g.length, m = 1; m < h.length; m++)
            (g += String(n(d, v, p))),
              (v += d.length + h[m].length),
              (g += h[m]);
          return g;
        },
      },
                ...
                c(
                  {},
                  {
                    menus: {
                      '*': {
                        '*': [
                          { path: '/', title: 'Hello statelink!', meta: {} },
                          {
                            title: 'Foo',
                            path: '/foo',
                            meta: {},
            ...
            },
            {
              ...
              meta: {
                ...
                slugs: [
                  {
                    depth: 2,
                    value: 'Hello statelink!',
                    heading: 'hello-statelink',
                  },
                ],
                title: 'Hello statelink!',
              },
              title: 'Hello statelink!',
            },
          ],
        ...
        toFixed: function(e) {
          ...
          if ((l < 0 && ((h = '-'), (l = -l)), l > 1e-21))
            if (
              ...
              m(1 << r), v(1, 1), m(2), (g = y());
            } else v(0, n), v(1 << -t, 0), (g = y() + a.call('0', p));
          return (
            p > 0
              ? ((u = g.length),
                (g =
  ...
  vRGJ: function(e, t, n) {
    ...
    function y(e, t, n) {
      return (
        r(t) || ((n = t || n), (t = [])),
        (n = n || {}),
        e instanceof RegExp ? h(e, t) : r(e) ? g(e, t, n) : v(e, t, n)
      );
    }
  },
  vZi8: function(e, t, n) {
  ...
  yl30: function(e, t, n) {
    ...
    function Er(e, t) {
      switch (e) {
        case 'compositionend':
          return br(t);
        case 'keypress':
          return 32 !== t.which ? null : ((mr = !0), gr);
        case 'textInput':
          return (e = t.data), e === gr && mr ? null : e;
        default:
          return null;
      }
    }
        ...
        extractEvents: function(e, t, n, r) {
          ...
          return (
            i
              ...
              : (o = null),
            (e = dr ? Er(e, n) : xr(e, n))
              ? ((t = cr.getPooled(vr.beforeInput, t, n, r)),
                (t.data = e),
                Qn(t))
              : (t = null),
    ...
    _ &&
      (jr =
        vt('input') && (!document.documentMode || 9 < document.documentMode));
    var Br = {
        eventTypes: Tr,
              ...
              e: {
                ...
                switch (((u = t), (g = n), m.tag)) {
                  ...
                  case 0:
                    if (
                      ((v = m.payload),
                      (u = 'function' === typeof v ? v.call(g, c, u) : v),
                      null === u || void 0 === u)
                    )
                      break e;
                    c = o({}, c, u);
    ...
    function zi(e) {
      ...
      function g(o, a, u, l) {
        for (
          var c = null, s = null, f = a, g = (a = 0), v = null;
          null !== f && g < u.length;
          g++
        ) {
    ...
    function Zi(e, t) {
      switch ((_o(Ki, t), _o($i, e), _o(Gi, Vi), (e = t.nodeType), e)) {
        case 9:
        case 11:
            ...
            if (((e = Yi(Gi.current)), Va(t))) {
              ...
              switch (((r[Fn] = t), (r[Un] = u), i)) {
                ...
                case 'details':
                  ...
                  break;
                case 'input':
                  Re(r, u), nn('invalid', r), mn(n, 'onChange');
                  break;
                case 'select':
              ...
              switch (
                ...
                case 'details':
                  ...
                  break;
                case 'input':
                  Re(e, r), (c = _e(e, r)), nn('invalid', e), mn(n, 'onChange');
                  break;
                case 'option':
                  c = Le(e, r);
                  break;
                case 'select':
                  ...
                  break;
                case 'textarea':
                  Fe(e, r), (c = Me(e, r)), nn('invalid', e), mn(n, 'onChange');
                  break;
                default:
                  c = r;
              }
    ...
    function Ol(e, t) {
      ...
      return (
        null !== o && (Ju === o && (Ml(t), nl === Zu && pc(o, tl)), dc(o, t)), o
      );
    }
    function Tl(e) {
    ...
    function _l(e, t) {
      ...
      var n = Tl(e);
      if (0 !== n) {
        if (((t = e.callbackNode), (Xu & (Wu | Vu)) !== zu))
          throw Error(a(327));
        if ((Gl(), (e === Ju && n === tl) || jl(e, n), null !== el)) {
          var r = Xu;
          Xu |= Wu;
          var o = Ll();
          do {
    ...
    function Rl(e) {
      var t = e.lastExpiredTime;
      if (((t = 0 !== t ? t : 1073741823), (Xu & (Wu | Vu)) !== zu))
        throw Error(a(327));
      if ((Gl(), (e === Ju && t === tl) || jl(e, t), null !== el)) {
        var n = Xu;
        Xu |= Wu;
        var r = Ll();
        do {
    ...
    function Wl(e, t) {
      ...
      if ((Xu & (Wu | Vu)) !== zu) throw Error(a(327));
    ...
    function $l() {
      if (null === vl) return !1;
      var e = vl;
      if (((vl = null), (Xu & (Wu | Vu)) !== zu)) throw Error(a(331));
      var t = Xu;
    ...
    Fu = function(e, t, n) {
      ...
      if (null !== e) {
        ...
        if (e.memoizedProps !== o || Po.current) Ka = !0;
        else {
          if (r < n) {
            switch (((Ka = !1), t.tag)) {
              case 3:
    ...
    (function(e) {
      ...
      (t.flushSync = function(e, t) {
        if ((Xu & (Wu | Vu)) !== zu) throw Error(a(187));
        var n = Xu;
        Xu |= 1;
        try {
